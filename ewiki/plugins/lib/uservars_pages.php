...
function ewiki_uservars_pages_search($varname, $value=NULL){
  ...
  $result = ewiki_database("SEARCH", array("content" => $varname));
...
function ewiki_uservars_pages_store($data=NULL, $username=NULL){
    ...
    $oldpage=ewiki_database("GET", array('id'=>EWIKI_USERVARS_PAGENAME_PREFIX.$username));
    ...
    return(ewiki_database("WRITE", $save));
}
...
function ewiki_uservars_pages_retrieve($username=NULL){
    ...
    $data=ewiki_database("GET", array('id'=>EWIKI_USERVARS_PAGENAME_PREFIX.$username));
